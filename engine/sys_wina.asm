...
_DATA SEGMENT
 align 4
 public ceil_cw, single_cw, full_cw, cw, pushed_cw, temp_cw
ceil_cw dd 0
single_cw dd 0
full_cw dd 0
cw dd 0
...
_Sys_SetFPCW:
 ...
 ret
 public _Sys_TruncateFPU
_Sys_TruncateFPU:
; This is disabled for now until we figure out how to make this work with the optimizer
; fnstcw temp_cw
; mov eax, ds:dword ptr[temp_cw]
; or ah, 00Ch
; mov ds:dword ptr[temp_cw], eax
; fldcw ds:word ptr[temp_cw]
 ret
_TEXT ENDS
 END