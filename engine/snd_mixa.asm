...
LClampDone2:
 ...
 pop esi
 ret
 public _SND_PaintChannelFrom8toDry
_SND_PaintChannelFrom8toDry:
 push esi
 push edi
 push ebx
 push ebp
...
LRightSet_:
 ...
 mov edi,ds:dword ptr[eax+ebx*4]
 mov ebp,ds:dword ptr[edx+ebx*4]
 add edi,ds:dword ptr[_drybuffer+0-8+ecx*8]
 add ebp,ds:dword ptr[_drybuffer+4-8+ecx*8]
 mov ds:dword ptr[_drybuffer+0-8+ecx*8],edi
 mov ds:dword ptr[_drybuffer+4-8+ecx*8],ebp
 mov bl,ds:byte ptr[-2+esi+ecx*1]
 dec ecx
 jz LDone_
LMix8Loop_:
 ...
 mov ebp,ds:dword ptr[edx+ebx*4]
 mov bl,ds:byte ptr[-3+esi+ecx*1]
 add edi,ds:dword ptr[_drybuffer+0-8*2+ecx*8]
 add ebp,ds:dword ptr[_drybuffer+4-8*2+ecx*8]
 mov ds:dword ptr[_drybuffer+0-8*2+ecx*8],edi
 mov ds:dword ptr[_drybuffer+4-8*2+ecx*8],ebp
 sub ecx,2
 jnz LMix8Loop_
LDone_:
 pop ebp
