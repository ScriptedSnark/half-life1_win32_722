...
typedef struct IA3dSound		*LPA3DSOUND;
typedef struct IA3dSoundBuffer	*LPA3DSOUNDBUFFER;
...
#define INTERFACE IA3d
	...
	DECLARE_INTERFACE_(IA3d, IUnknown)
	{
		...
		// IA3d Methods.
		STDMETHOD(SetOutputMode)
		(THIS_ DWORD, DWORD, DWORD) PURE;
		STDMETHOD(GetOutputMode)
		(THIS_ LPDWORD, LPDWORD, LPDWORD) PURE;
		STDMETHOD(SetResourceManagerMode)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetResourceManagerMode)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetHFAbsorbFactor)
		(THIS_ FLOAT) PURE;
		STDMETHOD(GetHFAbsorbFactor)
		(THIS_ FLOAT *)PURE;
	};
...
#define INTERFACE IA3d2
	...
	DECLARE_INTERFACE_(IA3d2, IUnknown)
	{
		...
		// IA3d2 Methods.
		STDMETHOD(RegisterVersion)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetSoftwareCaps)
		(THIS_ LPA3DCAPS_SOFTWARE) PURE;
		STDMETHOD(GetHardwareCaps)
		(THIS_ LPA3DCAPS_HARDWARE) PURE;
	};
...
#define INTERFACE IA3d3
	...
	DECLARE_INTERFACE_(IA3d3, IUnknown)
	{
		...
		STDMETHOD(Init)
		(THIS_ LPGUID, DWORD, DWORD) PURE;
		STDMETHOD(IsFeatureAvailable)
		(THIS_ DWORD) PURE;
		STDMETHOD(NewSource)
		(THIS_ DWORD, LPA3DSOURCE *)PURE;
		STDMETHOD(DuplicateSource)
		(THIS_ LPA3DSOURCE, LPA3DSOURCE *)PURE;
		STDMETHOD(SetCooperativeLevel)
		(THIS_ HWND, DWORD) PURE;
		STDMETHOD(GetCooperativeLevel)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetMaxReflectionDelayTime)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetMaxReflectionDelayTime)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetCoordinateSystem)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetCoordinateSystem)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetOutputGain)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetOutputGain)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetNumFallbackSources)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetNumFallbackSources)
		(THIS_ LPDWORD) PURE;
	};
...
#define INTERFACE IA3d4
	...
	DECLARE_INTERFACE_(IA3d4, IUnknown)
	{
		...
		STDMETHOD(GetNumFallbackSources)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetRMPriorityBias)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetRMPriorityBias)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(DisableViewer)
		(THIS) PURE;
		STDMETHOD(SetUnitsPerMeter)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetUnitsPerMeter)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetDopplerScale)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetDopplerScale)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetDistanceModelScale)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetDistanceModelScale)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetEq)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetEq)
...
#define INTERFACE IA3d5
	...
	DECLARE_INTERFACE_(IA3d5, IUnknown)
	{
		...
		(THIS_ DWORD) PURE;
		STDMETHOD(NewSource)
		(THIS_ DWORD, LPA3DSOURCE2 *)PURE;
		STDMETHOD(DuplicateSource)
		(THIS_ LPA3DSOURCE2, LPA3DSOURCE2 *)PURE;
		STDMETHOD(SetCooperativeLevel)
		(THIS_ HWND, DWORD) PURE;
		STDMETHOD(GetCooperativeLevel)
		(THIS_ LPDWORD) PURE;
		...
		// IA3d5 Methods
		STDMETHOD(InitEx)
		(THIS_ LPGUID, DWORD, DWORD, HWND, DWORD) PURE;
		STDMETHOD(NewReverb)
		(THIS_ LPA3DREVERB *)PURE;
		STDMETHOD(BindReverb)
		(THIS_ LPA3DREVERB) PURE;
		STDMETHOD(GetStreamingProperties)
		(THIS_ DWORD *, DWORD *)PURE;
		STDMETHOD(SetStreamingProperties)
		(THIS_ DWORD, DWORD) PURE;
		STDMETHOD(A3dEnumerate)
		(THIS_ LPA3DENUMCALLBACK, LPVOID) PURE;
		STDMETHOD(UnlockFallbackAC3Decoder)
		(THIS_ LPSTR, DWORD) PURE;
		STDMETHOD(SetMaxHardwareSources)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetMaxHardwareSources)
		(THIS_ LPDWORD) PURE;
	};
...
#define INTERFACE IA3dGeom
	...
	DECLARE_INTERFACE_(IA3dGeom, IUnknown)
	{
		...
		(THIS_ DWORD) PURE;
		STDMETHOD(SetOcclusionMode)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetOcclusionMode)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetReflectionMode)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetReflectionMode)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetReflectionGainScale)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetReflectionGainScale)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetReflectionDelayScale)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetReflectionDelayScale)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD_(ULONG, PushMatrix)
		(THIS) PURE;
		STDMETHOD_(ULONG, PopMatrix)
		(THIS) PURE;
		STDMETHOD(LoadIdentity)
		(THIS) PURE;
		STDMETHOD(LoadMatrix)
		(THIS_ A3DMATRIX) PURE;
		STDMETHOD(GetMatrix)
		(THIS_ A3DMATRIX) PURE;
		STDMETHOD(MultMatrix)
		(THIS_ A3DMATRIX) PURE;
		STDMETHOD(Translate3f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(Translate3fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(Rotate3f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(Rotate3fv)
		(THIS_ A3DVAL, LPA3DVAL) PURE;
		STDMETHOD(Scale3f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(Scale3fv)
		(THIS_ LPA3DVAL) PURE;
		...
		STDMETHOD(Tag)
		(THIS_ DWORD) PURE;
		STDMETHOD(SetOpeningFactorf)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(SetOpeningFactorfv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(NewMaterial)
		(THIS_ LPA3DMATERIAL *)PURE;
		STDMETHOD(BindMaterial)
		(THIS_ LPA3DMATERIAL) PURE;
		STDMETHOD(NewList)
		(THIS_ LPA3DLIST *)PURE;
		STDMETHOD(BindListener)
		(THIS) PURE;
		STDMETHOD(BindSource)
		(THIS_ LPA3DSOURCE2) PURE;
		STDMETHOD(NewEnvironment)
		(THIS_ LPA3DENVIRONMENT *)PURE;
		STDMETHOD(BindEnvironment)
		(THIS_ LPA3DENVIRONMENT) PURE;
		STDMETHOD(SetRenderMode)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetRenderMode)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetPolygonBloatFactor)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetPolygonBloatFactor)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetReflectionUpdateInterval)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetReflectionUpdateInterval)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetOcclusionUpdateInterval)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetOcclusionUpdateInterval)
		(THIS_ LPDWORD) PURE;
	};
...
#define INTERFACE IA3dGeom2
	...
	DECLARE_INTERFACE_(IA3dGeom2, IUnknown)
	{
		...
		// IA3dGeom2 Methods
		STDMETHOD(SetGeomReverbParam)
		(THIS_ LPA3DGEOMREVERBPARAM) PURE;
		STDMETHOD(GetGeomReverbParam)
		(THIS_ LPA3DGEOMREVERBPARAM) PURE;
	};
...
#define INTERFACE IA3dSource
	...
	DECLARE_INTERFACE_(IA3dSource, IUnknown)
	{
		...
		// IA3dSource Methods.
		STDMETHOD(LoadWaveFile)
		(THIS_ LPSTR) PURE;
		STDMETHOD(LoadWaveData)
		(THIS_ LPVOID, DWORD) PURE;
		STDMETHOD(AllocateWaveData)
		(THIS_ INT) PURE;
		STDMETHOD(FreeWaveData)
		(THIS) PURE;
		STDMETHOD(SetWaveFormat)
		(THIS_ LPVOID) PURE;
		STDMETHOD(GetWaveFormat)
		(THIS_ LPVOID) PURE;
		STDMETHOD(GetWaveSize)
		(THIS) PURE;
		STDMETHOD(GetType)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(Lock)
		...
		STDMETHOD(Rewind)
		(THIS) PURE;
		STDMETHOD(SetWaveTime)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetWaveTime)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetWavePosition)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetWavePosition)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetPosition3f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetPosition3f)
		(THIS_ LPA3DVAL, LPA3DVAL, LPA3DVAL) PURE;
		STDMETHOD(SetPosition3fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(GetPosition3fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetOrientationAngles3f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetOrientationAngles3f)
		(THIS_ LPA3DVAL, LPA3DVAL, LPA3DVAL) PURE;
		STDMETHOD(SetOrientationAngles3fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(GetOrientationAngles3fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetOrientation6f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL, A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetOrientation6f)
		(THIS_ LPA3DVAL, LPA3DVAL, LPA3DVAL, LPA3DVAL, LPA3DVAL, LPA3DVAL) PURE;
		STDMETHOD(SetOrientation6fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(GetOrientation6fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetVelocity3f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetVelocity3f)
		(THIS_ LPA3DVAL, LPA3DVAL, LPA3DVAL) PURE;
		STDMETHOD(SetVelocity3fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(GetVelocity3fv)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetCone)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetCone)
		(THIS_ LPA3DVAL, LPA3DVAL, LPA3DVAL) PURE;
		STDMETHOD(SetMinMaxDistance)
		(THIS_ A3DVAL, A3DVAL, DWORD) PURE;
		STDMETHOD(GetMinMaxDistance)
		(THIS_ LPA3DVAL, LPA3DVAL, LPDWORD) PURE;
		STDMETHOD(SetGain)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetGain)
		(THIS_ LPA3DVAL) PURE;
		...
		STDMETHOD(GetRenderMode)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(GetAudibility)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(GetOcclusionFactor)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(GetStatus)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetPanValues)
		(THIS_ DWORD, LPA3DVAL) PURE;
		STDMETHOD(GetPanValues)
		(THIS_ DWORD, LPA3DVAL) PURE;
		STDMETHOD(SetWaveEvent)
		(THIS_ DWORD, HANDLE) PURE;
		STDMETHOD(ClearWaveEvents)
		(THIS) PURE;
		STDMETHOD(SetTransformMode)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetTransformMode)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetReflectionDelayScale)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetReflectionDelayScale)
...
#define INTERFACE IA3dSource2
	...
	DECLARE_INTERFACE_(IA3dSource2, IUnknown)
	{
		...
		STDMETHOD(LoadWaveData)
		(THIS_ LPVOID, DWORD) PURE;
		STDMETHOD(AllocateAudioData)
		(THIS_ INT) PURE;
		STDMETHOD(FreeAudioData)
		(THIS) PURE;
		STDMETHOD(SetAudioFormat)
		(THIS_ LPVOID) PURE;
		STDMETHOD(GetAudioFormat)
		(THIS_ LPVOID) PURE;
		STDMETHOD_(DWORD, GetAudioSize)
		(THIS) PURE;
		STDMETHOD(GetType)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(Lock)
		...
		STDMETHOD(Rewind)
		(THIS) PURE;
		STDMETHOD(SetPlayTime)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetPlayTime)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetPlayPosition)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetPlayPosition)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetPosition3f)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetPosition3f)
		...
		STDMETHOD(GetPanValues)
		(THIS_ DWORD, LPA3DVAL) PURE;
		STDMETHOD(SetPlayEvent)
		(THIS_ DWORD, HANDLE) PURE;
		STDMETHOD(ClearPlayEvents)
		(THIS) PURE;
		STDMETHOD(SetTransformMode)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetTransformMode)
		...
		STDMETHOD(SetVolumetricBounds)
		(THIS_ A3DVAL, A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetVolumetricBounds)
		(THIS_ LPA3DVAL, LPA3DVAL, LPA3DVAL) PURE;
		STDMETHOD(SetVolumetricDamping)
		(THIS_ A3DVOLSRCDAMPINFO *)PURE;
		STDMETHOD(GetVolumetricDamping)
		(THIS_ A3DVOLSRCDAMPINFO *)PURE;
		STDMETHOD(SetReverbMix)
		(THIS_ A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetReverbMix)
		(THIS_ A3DVAL *, A3DVAL *)PURE;

		STDMETHOD(NewManualReflection)
		(THIS_ LPA3DREFLECTION *)PURE;
		STDMETHOD(FreeManualReflections)
		(THIS) PURE;
		STDMETHOD(GetNumManualReflections)
		(THIS_ int *)PURE;

		STDMETHOD(LoadFile)
		(THIS_ char *szFile, DWORD dwFormat) PURE;

		STDMETHOD(GetCaps)
		(THIS_ LPA3DCAPS_SOURCE lpSourceCaps) PURE;
	};
...
#undef INTERFACE
#define INTERFACE IA3dListener1

	DECLARE_INTERFACE_(IA3dListener1, IUnknown)
	{
		// IUnknown Methods.
		STDMETHOD(QueryInterface)
		(THIS_ REFIID, LPVOID FAR *)PURE;
...
#define INTERFACE IA3dMaterial
	...
	DECLARE_INTERFACE_(IA3dMaterial, IUnknown)
	{
		...
		STDMETHOD(Save)
		(THIS_ LPSTR) PURE;
		STDMETHOD(UnSerialize)
		(THIS_ LPVOID, UINT) PURE;
		STDMETHOD(Serialize)
		(THIS_ LPVOID *, UINT *)PURE;
		STDMETHOD(Duplicate)
		(THIS_ LPA3DMATERIAL *)PURE;
		...
		(THIS_ LPSTR) PURE;
		STDMETHOD(GetNameID)
		(THIS_ LPSTR, INT) PURE;
		STDMETHOD(SelectPreset)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetClosestPreset)
		(THIS_ LPDWORD) PURE;
		STDMETHOD(SetReflectance)
		(THIS_ A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetReflectance)
		(THIS_ LPA3DVAL, LPA3DVAL) PURE;
		STDMETHOD(SetTransmittance)
		(THIS_ A3DVAL, A3DVAL) PURE;
		STDMETHOD(GetTransmittance)
		(THIS_ LPA3DVAL, LPA3DVAL) PURE;
	};
...
#define INTERFACE IA3dPropertySet
	...
	DECLARE_INTERFACE_(IA3dPropertySet, IUnknown)
	{
		...
		(THIS_ REFGUID, ULONG, PULONG) PURE;
		STDMETHOD(Get)
		(THIS_ REFGUID, ULONG, LPVOID, ULONG, LPVOID, ULONG, PULONG) PURE;
		STDMETHOD(Set)
		(THIS_ REFGUID, ULONG, LPVOID, ULONG, LPVOID, ULONG, DWORD) PURE;
		STDMETHOD(AddInitialStateParameters)
		(THIS_ REFGUID, ULONG, LPVOID, ULONG, LPVOID, ULONG) PURE;
	};
...
#define INTERFACE IA3dReverb
	...
	DECLARE_INTERFACE_(IA3dReverb, IUnknown)
	{
		...
		// IA3dReverb Methods
		STDMETHOD(SetReverbPreset)
		(THIS_ DWORD) PURE;
		STDMETHOD(GetReverbPreset)
		(THIS_ DWORD *)PURE;
		STDMETHOD(SetAllProperties)
		(THIS_ A3DREVERB_PROPERTIES *)PURE;
		STDMETHOD(GetAllProperties)
		(THIS_ A3DREVERB_PROPERTIES *)PURE;
		STDMETHOD(SetPresetVolume)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetPresetVolume)
		(THIS_ A3DVAL *)PURE;
		STDMETHOD(SetPresetDecayTime)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetPresetDecayTime)
		(THIS_ A3DVAL *)PURE;
		STDMETHOD(SetPresetDamping)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetPresetDamping)
		(THIS_ A3DVAL *)PURE;
	};
...
#define INTERFACE IA3dReflection
	DECLARE_INTERFACE_(IA3dReflection, IUnknown)
	{
		...
		// IA3dReflect Methods
		STDMETHOD(SetGainScale)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetGainScale)
		(THIS_ LPA3DVAL) PURE;
		STDMETHOD(SetDelay)
		(THIS_ A3DVAL) PURE;
		STDMETHOD(GetDelay)
...
#define A3DERROR_AC3_FALLBACK_REQUIRES_DVD_DRIVE A3DERROR_CODE(93)
	...
	// IA3dSound
	//
	// Undocumented interface that is used by CA3DRenderer & CA3DSource2D
	// Special thanks to A3DLive
	//===================================================================

	// {62507921-3EA6-11D2-90FB-006008A1F441}
	DEFINE_GUID(IID_IA3dSound, 0x62507921, 0x3ea6, 0x11d2, 0x90, 0xfb, 0x00, 0x60, 0x08, 0xa1, 0xf4, 0x41);

#undef INTERFACE
#define INTERFACE IA3dSound
	DECLARE_INTERFACE_(IA3dSound, IUnknown)
	{
		// IUnknown Methods.
		STDMETHOD(QueryInterface)
		(THIS_ REFIID, LPVOID FAR *)PURE;
		...
		(THIS_ LPCDSBUFFERDESC, LPDIRECTSOUNDBUFFER *, LPUNKNOWN) PURE;
		STDMETHOD(GetCaps)
		(THIS_ LPDSCAPS) PURE;
		STDMETHOD(DuplicateSoundBuffer)
		(THIS_ LPDIRECTSOUNDBUFFER, LPDIRECTSOUNDBUFFER *)PURE;
		STDMETHOD(SetCooperativeLevel)
		(THIS_ HWND, DWORD);
		STDMETHOD(Compact)
		(THIS) PURE;
...
#undef INTERFACE
#define INTERFACE IA3dSoundBuffer
	DECLARE_INTERFACE_(IA3dSoundBuffer, IUnknown)
	{
		// IUnknown Methods.
		STDMETHOD(QueryInterface)
		(THIS_ REFIID, LPVOID FAR *)PURE;
		...
		(THIS_ LPDWORD) PURE;
		STDMETHOD(Initialize)
		(THIS_ LPDIRECTSOUND, LPCDSBUFFERDESC) PURE;
		STDMETHOD(Lock)
		(THIS_ DWORD, DWORD, LPVOID *, LPDWORD, LPVOID *, LPDWORD, DWORD) PURE;
		STDMETHOD(Play)
		(THIS_ DWORD, DWORD, DWORD) PURE;
...
{
	// BOOL			bIsHardware; // Seems like not present in GS
	BOOL bIsLooping;
	PROC_STATUS e3DStatus;
	PLAY_STATUS ePlayStatus;
} SOURCE3D_INFO;

typedef struct IA3dSoundBuffer *LPIA3SOUND;
typedef struct IA3dSoundBuffer *LPIA3SOUNDBUFFER;
...
struct CA3DListener
{
	struct CA3DListenerMembers
	{
		LPA3DLISTENER m_lpA3dListener;
		LPA3D3 m_lpA3d3;
		A3DVAL m_vPresentPos[3];
		A3DVAL m_vLastPos[3];
		A3DVAL m_fBias;
		A3DVAL m_fVelocity;
	} mbrs;
...
struct CA3DRenderer
{
	struct CA3DRendererMembers
	{
		LPA3D3 m_lpA3d3;
		DWORD m_Unreferenced0;
		CA3DListener* m_pA3dListener;
		RENDERER3D_INFO m_RendererInfo;

		A3DVAL m_fGlobalDoppler, m_fGlobalRollOff, m_fGlobalDistance;

		DWORD m_eSplashDisable;
		WAVEFORMATEX m_wfxFormat;

		LPA3DSOUNDBUFFER m_lpPrimaryBuffer;
		LPA3DLISTENER m_lpListener;

		DWORD m_dwPrimaryBufferBytes;

		A3DVAL m_fDistance, m_fDoppler, m_fRollOff;
		A3DVAL m_fAlpha;

		BOOL m_bA3dRendererInitialized;
		DWORD m_Unreferenced1;
		A3DVAL m_fOutputGain;
	} mbrs;
};

struct A3dGeomObject;
struct A3dLeaf;
struct A3dWorld;

struct A3dVertex
{
	struct A3dVertexMembers
	{
		DWORD tag;
		LPA3DVAL pos[3];
	} mbrs;
